            ...
            <div class="col-sm-10 col-md-10 col-lg-10 col-xl-10 admin__dashboard">
                ...
                <div class="row post__title">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 add__search">
                        <a class="btn btn-success" href="${pageContext.request.contextPath}/quan-tri/nguoi-dung/chinh-sua">Add New Course</a>
                ...
                <s:form method="POST" modelAttribute="model" action="${pageContext.request.contextPath}/quan-tri/san-pham/chinh-sua" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="custom-file">
                                    <!-- id="inputGroupFile01 -->
                                    <input name="multipartFile" type="file" class="custom-file-input" /> <label class="custom-file-label" for="inputGroupFile01">Choose
                                        file</label>
                                </div>
                            </div>
                            <s:hidden path="image" value="default.jpg"/>
                            <div class="table-responsive">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="input-group">
                                    ...
                                    <s:input path="quantity" class="form-control" />
                                </div>
                                <br />
                              	<div class="input-group mb-3">
				  					<div class="input-group-prepend">
				    					<label class="input-group-text" for="inputGroupSelect01">Roles</label>
				  					 	...
				  					 	<s:select path="category.id" class="custom-select" id="inputGroupSelect01"> 
				  								<s:option value="">--- Choose Roles ---</s:option>
