            ...
            <div class=" col-sm-2 col-md-2 col-lg-2 col-xl-2 px-0">
                <div class="admin__manager">
                   ...
                   <ul class="px-0 nav-ul">
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/quan-tri/san-pham?page=1&limit=5">Quản lí sản phẩm</a></li>
            ...
            <div class="col-sm-10 col-md-10 col-lg-10 col-xl-10 admin__dashboard">
                ...
                <div class="row post__title">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 add__search">
                     <a class="btn btn-success" href="${pageContext.request.contextPath}/quan-tri/san-pham/chinh-sua">Add New Course</a>
                ...
                <div class="modal" id="courseModal">
                    <div class="modal-dialog">
                        ...
                        <form action="<c:url value='/quan-tri/san-pham' />" id="formsubmit" method="get">
                      ...
                      <c:forEach var="product" items="${products}">
                        <tr>
                           <td>${ product.id }</td>
                    		<td>${ product.name }</td>
                         	<td>
                            	<img src="<spring:url value='/resources/photo/${product.image}' />" width="60px" height="60px" />
                            </td>
                            <td>${ product.price } VND</td>
                            <td>${ product.quantity } VND</td>
                            <td>${ product.description }</td>
                            <td>${ product.category.name }</td>
                            <td>
                            	<a href="${pageContext.request.contextPath}/quan-tri/san-pham/chinh-sua?id=${product.id}"
									class="btn btn-info mr-2"> <i class="fas fa-edit"></i> </a>
                              <a href="${pageContext.request.contextPath}/quan-tri/san-pham/${product.id}"
