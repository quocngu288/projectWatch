    ...
    <div class="container-fluid admin__panel px-0">
        ...
        <div class="row admin__content px-0">
            ...
            <div class="col-sm-10 col-md-10 col-lg-10 col-xl-10 admin__dashboard">
                ...
                <form action="<c:url value='/quan-tri/nguoi-dung' />" id="formsubmit" method="get">
                      ...
                      <c:forEach var="account" items="${accounts}">
                        <tr>
                           <td>${ account.id }</td>
                    		<td>${ account.email }</td>
                         	<td>
                            	<img src="<spring:url value='/resources/photo/${account.image}' />" width="60px" height="60px" />
                            </td>
                            <td>${ account.birthday }</td>
                            <td>
                            	<a href="${pageContext.request.contextPath}/quan-tri/nguoi-dung/chinh-sua?id=${account.id}"
									class="btn btn-info mr-2"> <i class="fas fa-edit"></i> </a>
                              <a href="${pageContext.request.contextPath}/quan-tri/nguoi-dung/${account.id}"
